...
async function getAIAnalysis(productName: string, brand: string | null, ingredients: string | null, signals: any, novaGroup?: number, nutriScore?: string): Promise<string> {
...
2. MiniCardBlock showing NOVA group and NutriScore with appropriate icons
3. TagBlock with quick status tags (FDA status, processing level, etc.)
4. SectionBlock with foldable sections for:
   - Ingredient breakdown
   - Health concerns (if any)
   - Positive aspects
5. CalloutV2 for any important warnings or recommendations
